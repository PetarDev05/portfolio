  ...
  return (
    <div className="flex flex-col items-center gap-10 w-full sm:w-150 py-15 px-7 sm:p-15 shadow-inner-sm sm:shadow-inner-md rounded-[30px]">
      ...
      <form className="w-full flex flex-col items-center gap-10">
        <input
          type="text"
          className="px-3 py-2 w-full bg-(--card-dark) text-(--white) rounded-lg"
        ...
        <input
          ...
          name="name"
        />
        <select name="" id="" className="px-3 py-2 w-full bg-(--card-dark) text-(--white) rounded-lg">
        ...
        <textarea
          name="message"
          id=""
          className="w-full p-3 min-h-32 resize-none bg-(--card-dark) text-(--white) rounded-lg"
