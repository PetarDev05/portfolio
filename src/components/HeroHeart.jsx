...
const HeroHeart = () => {
  return (
    <div className="flex flex-col sm:flex-row items-center gap-10 lg:gap-20 justify-between p-10 lg:px-20 lg:py-15 rounded-[45px] bg-(--white) dark:bg-(--dark-bg) shadow-inner-sm sm:shadow-inner-md">
